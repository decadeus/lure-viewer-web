  ...
  return (
    <div className="app-root app-root--dark">
      <TopMenuBar
        ...
        onDownloadLureGlb={handleDownloadLureGlb}
        onDownloadAttachGlb={handleDownloadAttachGlb}
        onDownloadBavetteGlb={handleDownloadBavetteGlb}
        hasSelectedAttach={!!selectedAttachAsset}
      />
      <div className="editor-layout">
        ...
        <div className="viewer-container">
          ...
          {showElementPopup && !previewMode && (
            <ElementPopup
              selectedPart={selectedPart}
              bavetteType={bavetteType}
              currentDimensionsCm={currentDimensionsCm}
              ...
              bavetteRotation={bavetteRotation}
              setBavetteRotation={setBavetteRotation}
              onClose={() => {
          ...
          {assetDockOpen && !previewMode && (
            <AssetDock
              assetDockHeight={assetDockHeight}
              setAssetDockHeight={setAssetDockHeight}
              assetLibrary={assetLibrary}
              setAssetLibrary={setAssetLibrary}
              assetDockTab={assetDockTab}
              setAssetDockTab={setAssetDockTab}
              fileInputModelRef={fileInputModelRef}
              handleImportModelFileChange={handleImportModelFileChange}
              modelType={modelType}
              selectedLocalModel={selectedLocalModel}
              setSelectedLocalModelId={setSelectedLocalModelId}
              setModelType={setModelType}
              localModels={localModels}
              setLocalModels={setLocalModels}
              selectedAttachAsset={selectedAttachAsset}
              selectedAttachId={selectedAttachId}
              setSelectedAttachId={setSelectedAttachId}
              attachSize={attachSize}
              attachColor={attachColor}
              builtinAttachSlots={builtinAttachSlots}
              bavetteOptions={bavetteOptions}
              bavetteType={bavetteType}
              setBavetteType={setBavetteType}
              bavetteThumbnails={bavetteThumbnails}
              setSelectedPart={setSelectedPart}
              setShowElementPopup={setShowElementPopup}
              selectedBavettePackUrl={selectedBavettePackUrl}
              currentDimensionsCm={currentDimensionsCm}
